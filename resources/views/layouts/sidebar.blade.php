            ...
            @if (menuPermission('Settings'))
                <li
                    ...
                    <ul class="treeview-menu">                        
                        ...
                        @endif
                        @if (routePermission('floor.index'))
                            <li class="menu_assign_class {{ request()->routeIs('floor.index') ? ' treeMenuActive' : '' }}" data-menu__cid="irp_10"><a
                                    href="{{ route('floor.index') }}">@lang('index.list_floor')</a>
                            </li>
                        @endif    
                        @if (routePermission('floor.create'))
                            <li class="menu_assign_class {{ request()->routeIs('floor.create') ? ' treeMenuActive' : '' }}" data-menu__cid="irp_10"><a
                                    href="{{ route('floor.create') }}">@lang('index.add_floor')</a>
                            </li>
                        @endif
                        @if (routePermission('production_table.index'))
                            <li class="menu_assign_class {{ request()->routeIs('production_table.index') ? ' treeMenuActive' : '' }}" data-menu__cid="irp_10"><a
                                    href="{{ route('production_table.index') }}">@lang('index.list_production_table')</a>
                            </li>
                        @endif    
                        @if (routePermission('production_table.create'))
                            <li class="menu_assign_class {{ request()->routeIs('production_table.create') ? ' treeMenuActive' : '' }}" data-menu__cid="irp_10"><a
                                    href="{{ route('production_table.create') }}">@lang('index.add_production_table')</a>
                            </li>
                        @endif
