                    ...
                    <table id="datatable" class="table table-striped">
                        <thead>
                            <tr>
                                ...
                                <th class="ir_w_10">@lang('index.table_name')</th>
                                <th class="ir_w_10">@lang('index.floor_select')</th>
                                <th class="ir_w_10">@lang('index.description_floor')</th>
                            ...
                            @foreach ($obj as $value)
                                <tr>
                                    ...
                                    <td class="ir_txt_center">
                                        ...
                                        @endif
                                        @if (routePermission('production_table.delete'))
                                            <a href="#" class="delete button-danger"
                                                ...
                                                <form action="{{ route('production_table.destroy', $value->id) }}"
