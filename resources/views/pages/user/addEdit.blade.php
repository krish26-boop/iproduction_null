            ...
            <div class="table-box">
                ...
                <div>
                    <div class="row">
                                ...
                                <select name="floor_id" id="floor_id"
                                    ...
                                    @foreach ($floors as $floor)
                                        <option value="{{ $floor->id }}"
                                            {{ (isset($obj) && $obj->floor_id == $floor->id) == $floor->id || old('floor_id') == $floor->id ? 'selected' : '' }}>
                                            {{ $floor->name ?? '' }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 mb-2">
                            <div class="form-group">
                                <label for="">@lang('index.table_name') {!! starSign() !!}</label>
                                <select name="table_id" id="table_id"
                                    class="form-control @error('table_id') is-invalid @enderror select2">
                                    <option value="">@lang('index.select')</option>
                                    @foreach ($tables as $table)
                                        <option value="{{ $table->id }}"
                                            {{ (isset($obj) && $obj->table_id == $table->id) == $table->id || old('table_id') == $table->id ? 'selected' : '' }}>
                                            {{ $table->table_name ?? '' }}
                                        </option>
                                    @endforeach
                                </select>
