...
unset($__errorArgs, $__bag); ?> select2">
                                    ...
                                    <?php $__currentLoopData = $floors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $floor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($floor->id); ?>"
                                            <?php echo e((isset($obj) && $obj->floor_id == $floor->id) == $floor->id || old('floor_id') == $floor->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 mb-2">
                            <div class="form-group">
                                <label for=""><?php echo app('translator')->get('index.table_name'); ?> <?php echo starSign(); ?></label>
...
unset($__errorArgs, $__bag); ?> select2">
                                    ...
                                    <?php $__currentLoopData = $tables; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $table): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($table->id); ?>"
                                            <?php echo e((isset($obj) && $obj->table_id == $table->id) == $table->id || old('table_id') == $table->id ? 'selected' : ''); ?>>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp-8.2\htdocs\iproduction_null\resources\views/pages/user/addEdit.blade.php ENDPATH**/ ?>