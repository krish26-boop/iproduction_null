                    ...
                    <table id="datatable" class="table table-striped">
                        <thead>
                            <tr>
                                ...
                                <th class="ir_w_10"><?php echo app('translator')->get('index.table_name'); ?></th>
                                <th class="ir_w_10"><?php echo app('translator')->get('index.floor_select'); ?></th>
                                <th class="ir_w_10"><?php echo app('translator')->get('index.description_floor'); ?></th>
                            ...
                            <?php $__currentLoopData = $obj; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td class="ir_txt_center">
                                        ...
                                        <?php endif; ?>
                                        <?php if(routePermission('production_table.delete')): ?>
                                            <a href="#" class="delete button-danger"
                                                ...
                                                <form action="<?php echo e(route('production_table.destroy', $value->id)); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp-8.2\htdocs\iproduction_null\resources\views/pages/production_table/index.blade.php ENDPATH**/ ?>