            ...
            <?php if(menuPermission('Settings')): ?>
                <li
                    ...
                    <ul class="treeview-menu">                        
                        ...
                        <?php endif; ?>
                        <?php if(routePermission('floor.index')): ?>
                            <li class="menu_assign_class <?php echo e(request()->routeIs('floor.index') ? ' treeMenuActive' : ''); ?>" data-menu__cid="irp_10"><a
                                    href="<?php echo e(route('floor.index')); ?>"><?php echo app('translator')->get('index.list_floor'); ?></a>
                            </li>
                        <?php endif; ?>    
                        <?php if(routePermission('floor.create')): ?>
                            <li class="menu_assign_class <?php echo e(request()->routeIs('floor.create') ? ' treeMenuActive' : ''); ?>" data-menu__cid="irp_10"><a
                                    href="<?php echo e(route('floor.create')); ?>"><?php echo app('translator')->get('index.add_floor'); ?></a>
                            </li>
                        <?php endif; ?>
                        <?php if(routePermission('production_table.index')): ?>
                            <li class="menu_assign_class <?php echo e(request()->routeIs('production_table.index') ? ' treeMenuActive' : ''); ?>" data-menu__cid="irp_10"><a
                                    href="<?php echo e(route('production_table.index')); ?>"><?php echo app('translator')->get('index.list_production_table'); ?></a>
                            </li>
                        <?php endif; ?>    
                        <?php if(routePermission('production_table.create')): ?>
                            <li class="menu_assign_class <?php echo e(request()->routeIs('production_table.create') ? ' treeMenuActive' : ''); ?>" data-menu__cid="irp_10"><a
                                    href="<?php echo e(route('production_table.create')); ?>"><?php echo app('translator')->get('index.add_production_table'); ?></a>
                            </li>
                        <?php endif; ?>
...
<?php /**PATH E:\xampp-8.2\htdocs\iproduction_null\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>